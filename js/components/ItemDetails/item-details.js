...
export class ItemDetails {
  ...
  createPurchasesContent(content){
    ...
    [
      ...
      ["Lowest Known Purchase Price", formatMoney(result.lowestKnownUnitCost)],
      ["Highest Known Purchase Price", formatMoney(result.highestKnownUnitCost)],
      ["Weighted Average Purchase Price", formatMoney(result.weightedAverageUnitCost)],
      ["Total Known Cost Basis", formatMoney(result.totalKnownCost)],
