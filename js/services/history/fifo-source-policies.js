...
function nonCashDisposal(transaction, tools){
  if (transaction.transactionStatus !== "deferred" || transaction.proceedsStatus !== "known_zero") throw new Error("unsupported_ledger_shape");
  return { demands: tools.createDisposalDemands(transaction), disposition: null };
}
export const FIFO_SOURCE_POLICY_REGISTRY = Object.freeze([
  ...
  { code: "non-cash-disposal", applies: (t) => t.accountingClassification === "non_cash_disposal", build: nonCashDisposal },
