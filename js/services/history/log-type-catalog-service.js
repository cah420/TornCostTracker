...
export const LOG_TYPE_CLASSIFICATIONS = Object.freeze({
  ...
  "1404": { classification: "Accounting relevant", reason: "Verified Dump find zero-cash item acquisition." },
  "2536": { classification: "Ignored", reason: "Halloween treat receipt does not add owned inventory and is excluded from acquisition accounting." },
  "4101": { classification: "Accounting relevant", reason: "Verified legacy gift received; creates zero-cash acquisition supply." },
  "4103": { classification: "Accounting relevant", reason: "Verified gift received; creates zero-cash acquisition supply." },
  "4850": { classification: "Accounting relevant", reason: "Verified points-funded Keepsake acquisition with deferred cash basis." },
  "5251": { classification: "Accounting relevant", reason: "Verified multi-item Referral reward with unknown cash basis." },
  "5530": { classification: "Accounting relevant", reason: "Verified Stock special item reward with unknown cash basis." },
  "5575": { classification: "Accounting relevant", reason: "Verified multi-item Subscription reward with unknown cash basis." },
  "5802": { classification: "Accounting relevant", reason: "Verified programmed-virus acquisition resolved through the Item Resolution service with zero cash basis." },
  "6401": { classification: "Accounting relevant", reason: "Verified job-point-funded item acquisition with deferred cash basis." },
  "6505": { classification: "Accounting relevant", reason: "Verified company job-point-funded item acquisition with deferred cash basis." },
  "6797": { classification: "Accounting relevant", reason: "Verified multi-item Faction payout reward with unknown cash basis." },
  "7900": { classification: "Accounting relevant", reason: "Verified mission-credit-funded item acquisition with deferred cash basis." },
  "8377": { classification: "Accounting relevant", reason: "Verified Wheel item reward with unknown cash basis." },
  "8930": { classification: "Accounting relevant", reason: "Verified Christmas Town find with zero cash basis." },
  "8934": { classification: "Accounting relevant", reason: "Verified Christmas-buck-funded item acquisition with deferred cash basis." },
  "8938": { classification: "Accounting relevant", reason: "Verified multi-item Christmas Town reward with unknown cash basis." },
  "8980": { classification: "Accounting relevant", reason: "Verified Easter egg pickup with zero cash basis." },
